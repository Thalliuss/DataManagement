...
public class DataManager : MonoBehaviour
{
    ...
    private void Build()
    {
        ...
        DataBuilder.BuildElementsOfType<Account>();
    }
    ...
    public void Save()
    {
        if (multipleSaves) {
            ...
            if (Directory.Exists(_path + "/")) {
                ...
                {
                    print(Application.persistentDataPath + (Directory.GetFiles(_path)[i].Replace(Application.persistentDataPath, "")) + "_" + _time);
                    File.Copy(Directory.GetFiles(_path)[i], _path + (Directory.GetFiles(_path)[i].Replace(Application.persistentDataPath, "")) + "_" + _time);
                }
